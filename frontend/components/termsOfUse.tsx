        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="prose prose-lg max-w-none text-gray-300 prose-headings:text-white prose-headings:font-bricolage prose-p:font-montserrat">
            <p>
              ...
              Use&quot;) carefully before using the Memory Ball application and
              website (collectively, the &quot;Service&quot;) operated by Memory
              Ball (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
            </p>
            ...
            <p>
              ...
              are and will remain the exclusive property of Memory Ball and its
              ...
              product or service without the prior written consent of Memory
              Ball.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">User Content</h2>
            <p>
              Our Service allows you to create, upload, save, share, and manage
              flashcards, decks, and other content (&quot;User Content&quot;).
              You are solely responsible for the User Content that you post,
              upload, link to, or otherwise make available via the Service.
            </p>

            <p>
              You retain all rights to your User Content. By posting User
              Content on or through the Service, you grant us a worldwide,
              non-exclusive, royalty-free license to use, copy, modify,
              reproduce, process, adapt, publish, transmit, and display your
              User Content to provide and maintain the Service.
            </p>

            <p>You represent and warrant that:</p>
            <ul className="list-disc pl-6 mb-6 font-montserrat">
              <li>
                You own the User Content posted by you on or through the Service
                or otherwise have the right to grant the rights and licenses set
                forth in these Terms.
              </li>
              <li>
                The posting and use of your User Content on or through the
                Service does not violate, misappropriate, or infringe on the
                rights of any third party, including privacy rights, publicity
                rights, copyrights, trademark, and/or other intellectual
                property rights.
              </li>
              <li>
                Your User Content does not contain any material that violates
            ...
            <ul className="list-disc pl-6 mb-6 font-montserrat">
              ...
              <li>
                To impersonate or attempt to impersonate Memory Ball, a Memory
                Ball employee, another user, or any other person or entity.
              </li>
              <li>
                To engage in any other conduct that restricts or inhibits
                anyone&apos;s use or enjoyment of the Service, or which may harm
                Memory Ball or users of the Service, or expose them to
                liability.
              </li>
              <li>
              ...
              <li>
                To interfere with or attempt to gain unauthorized access to the
            ...
            <p>
              In no event shall Memory Ball, nor its directors, employees,
            ...
            <p>
              Memory Ball, its subsidiaries, affiliates, and licensors do not
              warrant that:
            </p>
            <ul className="list-disc pl-6 mb-6 font-montserrat">
              <li>
